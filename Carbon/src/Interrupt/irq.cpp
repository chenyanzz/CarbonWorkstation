...
//	set_idt(IRQ(APIC_TIMER_IRQ),deal_irq_0, KNL_PROGRAM_SEG,0,IDT_DESC_ATTR_DPL0);//ACPI时钟
    set_idt(IRQ(PIT_TIMER_IRQ), deal_irq_0, KNL_PROGRAM_SEG,0,IDT_DESC_ATTR_DPL0);//PIT时钟
    set_idt(IRQ(RTC_TIMER_IRQ), deal_irq_8, KNL_PROGRAM_SEG,0,IDT_DESC_ATTR_DPL0);//RTC实时时钟
    set_idt(IRQ(KEYBOARD_IRQ), deal_irq_1, KNL_PROGRAM_SEG,0,IDT_DESC_ATTR_DPL0);//键盘
}
